...
public abstract class MovingObject implements Runnable {
	...
	/**
	 * Gets the XSpeed of the balls
	 */
	public static double getXSpeed;
	/**
	 * Gets the YSpeed of the balls
	 */
	 ...
	 *            New x speed.
	 */
	public void setXSpeed(double xSpeed, int how) {
		this.xSpeed = xSpeed * how;
	}
	 ...
	 *            New y speed.
	 */
	public void setYSpeed(double ySpeed, int how) {
		this.ySpeed = ySpeed * how;
	}
